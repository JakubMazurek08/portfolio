...
export const ProjectCard = ({title, text, img, icons, url} : ProjectCardProps) => {
    return (
        <div className="flex flex-col p-4 sm:p-8 rounded-[10px] sm:rounded-[15px] my-16 sm:bg-darkGray gap-4 w-full">
            <Text variant={"h1"}>{title}<span className="text-accent">.</span></Text>
            <div className={'min-h-[300px] sm:min-h-[125px]'}><Text>{text}</Text></div>
